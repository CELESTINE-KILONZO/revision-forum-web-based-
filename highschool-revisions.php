        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-4">
                    ...
                    <button id="mathUnlockButton" class="btn btn-primary" onclick="showPaymentForm('mathUnlockButton')">Unlock Video</button>
                </div>
                ...
                <div class="col-md-4">
                    ...
                    <button id="physicsUnlockButton" class="btn btn-primary" onclick="showPaymentForm('physicsUnlockButton')">Unlock Video</button>
                </div>
                ...
                <div class="col-md-4">
                    ...
                    <button id="chemUnlockButton" class="btn btn-primary" onclick="showPaymentForm('chemUnlockButton')">Unlock Video</button>
                </div>
            </div>
        </div>
    </section>
