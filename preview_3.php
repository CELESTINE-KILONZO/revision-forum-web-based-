...
<body>
    ...
    <div class="video-list">
        ...
        <div class="video-item">
            ...
            <button onclick="unlockVideo('mathVideo')">Unlock Video</button>
        </div>
        ...
        <div class="video-item">
            ...
            <button onclick="unlockVideo('physicsVideo')">Unlock Video</button>
        </div>
        ...
        <div class="video-item">
            ...
            <button onclick="unlockVideo('chemistryVideo')">Unlock Video</button>
        </div>
